...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TEAMLANA,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId) 
if UserId == 1330047630 then
Status = true
elseif UserId == 1330047630 then
Status = true
...
Status = 0
Developers = Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(TEAMLANA.."TEAMLANA:Developer:Bot:Reply"..ChatId) or 'Myth'
elseif TheBasics then
Status = Redis:get(TEAMLANA.."TEAMLANA:President:Group:Reply"..ChatId) or 'المنشى الاساسي'
elseif Originators then
Status = Redis:get(TEAMLANA.."TEAMLANA:Constructor:Group:Reply"..ChatId) or 'المنشى'
elseif Managers then
Status = Redis:get(TEAMLANA.."TEAMLANA:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TEAMLANA.."TEAMLANA:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(TEAMLANA.."TEAMLANA:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TEAMLANA.."TEAMLANA:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
change_info = '❬ √ ❭' else change_info = '❬ 𝚇 ❭'
end
if GetMemberStatus.can_delete_messages then
delete_messages = '❬ √ ❭' else delete_messages = '❬ 𝚇 ❭'
end
if GetMemberStatus.can_invite_users then
invite_users = '❬ √ ❭' else invite_users = '❬ 𝚇 ❭'
end
if GetMemberStatus.can_pin_messages then
pin_messages = '❬ √ ❭' else pin_messages = '❬ 𝚇 ❭'
end
if GetMemberStatus.can_restrict_members then
restrict_members = '❬ √ ❭' else restrict_members = '❬ 𝚇 ❭'
end
...
if Redis:get(TEAMLANA.."TEAMLANA:lockpin"..ChatId) then    
lock_pin = "√"
else 
lock_pin = "𝚇"    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:tagservr"..ChatId) then    
lock_tagservr = "√"
else 
lock_tagservr = "𝚇"
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:text"..ChatId) then    
lock_text = "√"
else 
lock_text = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "√"
else 
lock_add = "𝚇 "    
end    
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Join"..ChatId) == "kick" then
lock_join = "√"
else 
lock_join = "𝚇 "    
end    
if Redis:get(TEAMLANA.."TEAMLANA:Lock:edit"..ChatId) then    
lock_edit = "√"
else 
lock_edit = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Chek:Welcome"..ChatId) then
welcome = "√"
else 
welcome = "𝚇 "    
end
if Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "√"
else     
flood = "𝚇 "     
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId) == "del" then
lock_photo = "√" 
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "𝚇 "   
end    
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId) == "del" then
lock_phon = "√" 
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "𝚇 "    
end    
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId) == "del" then
lock_links = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId) == "del" then
lock_user = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId) == "del" then
lock_hash = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId) == "del" then
lock_muse = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "𝚇 "    
end 
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId) == "del" then
lock_ved = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId) == "del" then
lock_gif = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId) == "del" then
lock_ste = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId) == "del" then
lock_geam = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "𝚇 "    
end    
...
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "𝚇 "
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId) == "del" then
lock_fwd = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "𝚇 "    
end    
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId) == "del" then
lock_file = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "𝚇 "    
end    
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId) == "del" then
lock_self = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "𝚇 "    
end
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId) == "del" then    
lock_spam = "√"
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "𝚇 "    
end        
...
return{
kkytmAll = Redis:sismember(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId) ,
BanAll = Redis:sismember(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TEAMLANA.."TEAMLANA:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TEAMLANA.."TEAMLANA:SilentGroup:Group"..ChatId,UserId)
}
end
...
Managers = Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..ChatId,UserId)
channelis = Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1330047630 then
Status = true
...
JoinChannel = true
local Channel = Redis:get(TEAMLANA..'TEAMLANA:Channel:Join')
if Channel then
...
local msg_id = msg.id
if data.sender.luatele == "messageSenderChat" and Redis:get(TEAMLANA.."Lock:channell"..msg_chat_id) and not msg.channelis then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
Redis:incr(TEAMLANA..'TEAMLANA:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == 1330047630 then
msg.Name_Controller = 'Ace🎖 '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1330047630 then
msg.Name_Controller = 'Ace🎖'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'Dev🎖'
elseif Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️'
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TEAMLANA.."TEAMLANA:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TEAMLANA.."TEAMLANA:President:Group:Reply"..msg.chat_id) or 'المنشى الاساسي'
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TEAMLANA.."TEAMLANA:Constructor:Group:Reply"..msg.chat_id) or 'المنشى '
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TEAMLANA.."TEAMLANA:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TEAMLANA.."TEAMLANA:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TEAMLANA.."TEAMLANA:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TEAMLANA) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TEAMLANA.."TEAMLANA:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TEAMLANA.."TEAMLANA:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TEAMLANA.."TEAMLANA:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TEAMLANA.."TEAMLANA:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TEAMLANA) then
return false
end
local floods = Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TEAMLANA.."TEAMLANA:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TEAMLANA.."TEAMLANA:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TEAMLANA.."TEAMLANA:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TEAMLANA.."TEAMLANA:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TEAMLANA.."TEAMLANA:lockpin"..msg_chat_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ ما اقدر تثبيت الرسائل ليست لديه صلاحيه","md",true)
end
end
local UnPin = LuaTele.unpinChatMessage(msg_chat_id) 
if UnPin.luatele ~= "ok" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ ما اقدر الغاء تثبيت الرسائل ليست لديه صلاحيه","md",true)
end
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TEAMLANA.."TEAMLANA:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TEAMLANA.."TEAMLANA:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TEAMLANA.."TEAMLANA:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TEAMLANA.."TEAMLANA:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(TEAMLANA..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
if msg.content.luatele == "messageContact" and not msg.Distinguished then  -- الجهات
local Contact_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TEAMLANA.."TEAMLANA:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TEAMLANA.."TEAMLANA:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TEAMLANA.."TEAMLANA:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ ما اقدر تغيير صوره المجموعه لاني لست ادمن او ليست لديه الصلاحيه ","md",true)    
end
Redis:del(TEAMLANA.."TEAMLANA:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TEAMLANA.."TEAMLANA:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TEAMLANA.."TEAMLANA:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TEAMLANA.."TEAMLANA:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TEAMLANA.."TEAMLANA:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TEAMLANA.."TEAMLANA:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TEAMLANA.."TEAMLANA:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TEAMLANA.."TEAMLANA:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TEAMLANA.."TEAMLANA:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TEAMLANA.."TEAMLANA:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TEAMLANA.."TEAMLANA:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TEAMLANA.."TEAMLANA:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TEAMLANA.."TEAMLANA:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TEAMLANA.."TEAMLANA:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TEAMLANA.."TEAMLANA:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
Redis:del(TEAMLANA.."TEAMLANA:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TEAMLANA.."TEAMLANA:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TEAMLANA.."TEAMLANA:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TEAMLANA.."TEAMLANA:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TEAMLANA.."TEAMLANA:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ ارسل الامر الجديد ليتم وضعه مكان القديم ","md",true)  
end
if text and Redis:get(TEAMLANA.."TEAMLANA:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TEAMLANA.."TEAMLANA:Command:Reids:Group:New"..msg_chat_id)
...
local list = Redis:smembers(TEAMLANA.."TEAMLANA:ChekBotAdd") 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TEAMLANA.."TEAMLANA:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌯' then   
Redis:del(TEAMLANA.."TEAMLANA:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌯ اهلا عزيزي , تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TEAMLANA..'TEAMLANA:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TEAMLANA.."TEAMLANA:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌯' then   
Redis:del(TEAMLANA.."TEAMLANA:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌯ اهلا عزيزي , تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TEAMLANA.."TEAMLANA:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TEAMLANA.."TEAMLANA:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TEAMLANA.."TEAMLANA:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TEAMLANA.."TEAMLANA:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌯' then   
Redis:del(TEAMLANA.."TEAMLANA:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TEAMLANA..'TEAMLANA:GetTexting:DevTEAMLANA'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TEAMLANA..'TEAMLANA:GetTexting:DevTEAMLANA'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌯ اهلا عزيزي , تم الغاء تغيير كليشه Dev🎖')
end
Redis:set(TEAMLANA..'TEAMLANA:Texting:DevTEAMLANA',text)
Redis:del(TEAMLANA..'TEAMLANA:GetTexting:DevTEAMLANA'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌯ تم حفظ كليشة Dev🎖')
end
if Redis:get(TEAMLANA.."TEAMLANA:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌯ اهلا عزيزي , تم الغاء تعيين الايدي عام ","md",true)  
Redis:del(TEAMLANA.."TEAMLANA:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TEAMLANA.."TEAMLANA:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TEAMLANA.."TEAMLANA:Set:Id:all",text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TEAMLANA.."TEAMLANA:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌯ اهلا عزيزي , تم الغاء تعيين الايدي ","md",true)  
Redis:del(TEAMLANA.."TEAMLANA:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TEAMLANA.."TEAMLANA:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TEAMLANA.."TEAMLANA:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TEAMLANA.."TEAMLANA:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TEAMLANA.."TEAMLANA:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌯ اهلا عزيزي , تم الغاء اسم البوت ","md",true)  
end 
Redis:del(TEAMLANA.."TEAMLANA:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TEAMLANA.."TEAMLANA:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌯ تم تغيير اسم البوت الى ⌯ "..text,"md",true)    
end 
if Redis:get(TEAMLANA.."TEAMLANA:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TEAMLANA.."TEAMLANA:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌯ اهلا عزيزي , تم الغاء تغيير كليشه start","md",true)  
end 
Redis:del(TEAMLANA.."TEAMLANA:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TEAMLANA.."TEAMLANA:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌯ تم تغيير كليشه start ⌯ "..text,"md",true)    
end 
if Redis:get(TEAMLANA.."TEAMLANA:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TEAMLANA.."TEAMLANA:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TEAMLANA.."TEAMLANA:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TEAMLANA.."TEAMLANA:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TEAMLANA.."TEAMLANA:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TEAMLANA.."TEAMLANA:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ اهلا عزيزي , تم الغاء الترحيب ","md",true)   
end 
Redis:del(TEAMLANA.."TEAMLANA:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TEAMLANA.."TEAMLANA:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TEAMLANA.."TEAMLANA:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TEAMLANA.."TEAMLANA:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ اهلا عزيزي , تم الغاء القوانين","md",true)   
end 
Redis:set(TEAMLANA.."TEAMLANA:Group:Rules" .. msg_chat_id,text) 
Redis:del(TEAMLANA.."TEAMLANA:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TEAMLANA.."TEAMLANA:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TEAMLANA.."TEAMLANA:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text == "الغاء" then 
Redis:del(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ اهلا عزيزي , تم الغاء الرد","md",true)   
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TEAMLANA.."TEAMLANA:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
print(idPhoto)
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ اضفت الرد بنجاح \n⌯ ارسل ( "..test.." ) لتشوف الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TEAMLANA.."TEAMLANA:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TEAMLANA.."TEAMLANA:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/B_5_J'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TEAMLANA.."TEAMLANA:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم حذف الرد من الردود ","md",true)  
return false
end
end
if text and Redis:get(TEAMLANA.."TEAMLANA:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local Text = Text:gsub('#اليوزر',(UserInfo.username or 'مافيه')) 
...
if text and Redis:get(TEAMLANA.."TEAMLANA:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local Texingt = Texingt:gsub('#اليوزر',(UserInfo.username or 'مافيه')) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TEAMLANA.."TEAMLANA:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TEAMLANA.."TEAMLANA:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TEAMLANA.."TEAMLANA:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."TEAMLANA:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TEAMLANA.."TEAMLANA:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TEAMLANA.."TEAMLANA:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TEAMLANA.."TEAMLANA:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."TEAMLANA:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(TEAMLANA..'TEAMLANA:'..v..text)
end
Redis:del(TEAMLANA.."TEAMLANA:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TEAMLANA.."TEAMLANA:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم حذف الرد من الردود العامه","md",true)  
end
end
if Redis:get(TEAMLANA.."TEAMLANA:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ عذراً لا يمكنك تخمين عدد اكبر من ال  20  خمن رقم ما بين ال 1 و 20 \n","md",true)  
end 
local GETNUM = Redis:get(TEAMLANA.."TEAMLANA:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TEAMLANA.."TEAMLANA:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TEAMLANA.."TEAMLANA:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ مبروك فزت معنا وخمنت الرقم الصحيح\n⌯ تم اضافة  5  من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TEAMLANA.."TEAMLANA:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TEAMLANA.."TEAMLANA:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TEAMLANA.."TEAMLANA:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TEAMLANA.."TEAMLANA:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TEAMLANA.."TEAMLANA:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TEAMLANA.."TEAMLANA:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TEAMLANA.."TEAMLANA:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(TEAMLANA.."TEAMLANA:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TEAMLANA.."TEAMLANA:Game:Riddles"..msg.chat_id) then
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TEAMLANA.."TEAMLANA:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(TEAMLANA.."TEAMLANA:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TEAMLANA.."TEAMLANA:Game:Reflection"..msg.chat_id) then
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TEAMLANA.."TEAMLANA:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(TEAMLANA.."TEAMLANA:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TEAMLANA.."TEAMLANA:Game:Monotonous"..msg.chat_id) then
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TEAMLANA.."TEAMLANA:Game:Monotonous"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(TEAMLANA.."TEAMLANA:Game:Difference"..msg.chat_id) then
if text == Redis:get(TEAMLANA.."TEAMLANA:Game:Difference"..msg.chat_id) then
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TEAMLANA.."TEAMLANA:Game:Difference"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ اجابتك صحيحة كفو عليك ","md",true)  
end
end
if text then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TEAMLANA..'TEAMLANA:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TEAMLANA..'TEAMLANA:Channel:Join')}, },}}
...
Y = Y + 1
Redis:sadd(TEAMLANA..'TEAMLANA:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TEAMLANA.."TEAMLANA:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TEAMLANA.."TEAMLANA:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TEAMLANA.."TEAMLANA:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TEAMLANA.."TEAMLANA:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TEAMLANA.."TEAMLANA:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TEAMLANA.."TEAMLANA:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(TEAMLANA.."TEAMLANA:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TEAMLANA.."TEAMLANA:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TEAMLANA.."TEAMLANA:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TEAMLANA.."TEAMLANA:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TEAMLANA.."TEAMLANA:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TEAMLANA..'TEAMLANA:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TEAMLANA..'TEAMLANA:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
Redis:del(TEAMLANA..'TEAMLANA:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ عذراً مافيه حساب بهاذا المعرف ","md",true)  
end
local ChannelUser = text:gsub('@','')
if UserId_Info.type.is_channel == true then
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TEAMLANA).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TEAMLANA..'TEAMLANA:Channel:Join',ChannelUser) 
Redis:set(TEAMLANA..'TEAMLANA:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(TEAMLANA..'TEAMLANA:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TEAMLANA..'TEAMLANA:Channel:Join')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ تم عطلت الاشتراك الاجباري","md",true)  
end
...
download('https://raw.githubusercontent.com/Fawazz77/Rhps/blob/main/TEAMLANA.lua','TEAMLANA.lua')
...
local Groups = Redis:smembers(TEAMLANA..'TEAMLANA:ChekBotAdd')  
local UsersBot = Redis:smembers(TEAMLANA..'TEAMLANA:Num:User:Pv')  
...
local President = Redis:smembers(TEAMLANA.."TEAMLANA:TheBasics:Group"..v)
local Constructor = Redis:smembers(TEAMLANA.."TEAMLANA:Originators:Group"..v)
local Manager = Redis:smembers(TEAMLANA.."TEAMLANA:Managers:Group"..v)
local Admin = Redis:smembers(TEAMLANA.."TEAMLANA:Addictive:Group"..v)
local Vips = Redis:smembers(TEAMLANA.."TEAMLANA:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TEAMLANA.."TEAMLANA:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TEAMLANA.."TEAMLANA:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TEAMLANA..'TEAMLANA:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'⌯ عدد احصائيات البوت الكامله \n↫ ┄┄┄┄┄𝙻𝙰𝙽𝙰┄┄┄┄┄ ↬ \n⌯ عدد المجموعات : '..(Redis:scard(TEAMLANA..'TEAMLANA:ChekBotAdd') or 0)..'\n⌯ عدد المشتركين : '..(Redis:scard(TEAMLANA..'TEAMLANA:Num:User:Pv') or 0)..'',"md",true)  
end
...
LuaTele.sendText(Sudo_Id,0,'\n⌯ تم فعلت مجموعه جديده \n⌯ من قام بتفعيلها :  [' ..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n⌯ معلومات المجموعه :\n⌯ عدد الاعضاء : '..Info_Chats.member_count..'\n⌯ عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌯ عدد المطرودين : '..Info_Chats.banned_count..'\n⌯ عدد المقيدين : '..Info_Chats.restricted_count..'',"md",true, false, false, false, reply_markup)
end
Redis:sadd(TEAMLANA.."TEAMLANA:ChekBotAdd",msg_chat_id)

Redis:set(TEAMLANA.."TEAMLANA:Status:Link"..msg_chat_id,true) ;Redis:set(TEAMLANA.."TEAMLANA:Status:Id"..msg_chat_id,true) ;Redis:set(TEAMLANA.."TEAMLANA:Status:Reply"..msg_chat_id,true) ;Redis:set(TEAMLANA.."TEAMLANA:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TEAMLANA.."TEAMLANA:Status:BanId"..msg_chat_id,true) ;Redis:set(TEAMLANA.."TEAMLANA:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ المجموعه : ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') \n⌯ تم فعلت المجموعه ','md', true, false, false, false, reply_markup)
end
end 
...
if not Redis:get(TEAMLANA.."TEAMLANA:BotFree") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ الوضع الخدمي تم عطلته من قبل Dev🎖 البوت ","md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(TEAMLANA.."TEAMLANA:ChekBotAdd",msg_chat_id) then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TEAMLANA.."TEAMLANA:ChekBotAdd",msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ المجموعه : ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') \n⌯ تم عطلتها مسبقا ',"md",true)  
else
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
...
LuaTele.sendText(Sudo_Id,0,'\n⌯ تم عطلت مجموعه جديده \n⌯ من قام بتعطيلها : ['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n⌯ معلومات المجموعه :\n⌯ عدد الاعضاء : '..Info_Chats.member_count..'\n⌯ عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌯ عدد المطرودين : '..Info_Chats.banned_count..'\n⌯ عدد المقيدين : '..Info_Chats.restricted_count..'',"md",true, false, false, false, reply_markup)
end
Redis:srem(TEAMLANA.."TEAMLANA:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ المجموعه : ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') \n⌯ تم عطلتها بنجاح ','md',true)
end
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TEAMLANA.."TEAMLANA:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(TEAMLANA.."TEAMLANA:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TEAMLANA.."TEAMLANA:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {""}
...
Get_Is_Id = Redis:get(TEAMLANA.."TEAMLANA:Set:Id:all") or Redis:get(TEAMLANA.."TEAMLANA:Set:Id:Group"..msg_chat_id)
if Redis:get(TEAMLANA.."TEAMLANA:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
...
local TotalMsg = Redis:get(TEAMLANA..'TEAMLANA:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
...
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TEAMLANA.."TEAMLANA:AddSudosNew"..msg_chat_id)
...
if UserId_Info.type.is_channel == true then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ عذراً لا تستطيع استخدام معرف قناة او مجموعه ","md",true)  
end
...
Redis:set(TEAMLANA.."TEAMLANA:AddSudosNew"..msg_chat_id,true)
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله Myth مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم تنزيله M مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم تنزيله Myth مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته Myth ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
...
if Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TEAMLANA.."TEAMLANA:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId_Info.id) 
Redis:sadd(TEAMLANA.."TEAMLANA:id:ch",UserId_Info.id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته Myth ").Reply,"md",true)  
end
end
if TextMsg == "منشئ اساسي" then
...
if Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم ترقيته Myth ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ اساسي" then
...
if Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TEAMLANA.."TEAMLANA:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TEAMLANA.."TEAMLANA:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TEAMLANA.."TEAMLANA:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TEAMLANA.."TEAMLANA:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TEAMLANA.."TEAMLANA:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TEAMLANA.."TEAMLANA:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:DevelopersQ:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ مافيه Myth🎖️ حالياً , ","md",true)  
end
ListMembers = '\n⌯ قائمه Myth🎖\n ↫ ┄┄┄┄┄𝙻𝙰𝙽𝙰┄┄┄┄┄ ↬ \n'
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ مافيه Myth حالياً , ","md",true)  
end
ListMembers = '\n⌯ قائمه Myth البوت \n ↫ ┄┄┄┄┄𝙻𝙰𝙽𝙰┄┄┄┄┄ ↬ \n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TEAMLANA.."TEAMLANA:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TEAMLANA.."TEAMLANA:Status:Welcome"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الترحيب ","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:Status:Id"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الايدي ","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:Status:IdPhoto"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الايدي بالصوره ","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:Status:Reply"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الردود ","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:Status:ReplySudo"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الردود العامه ","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:Status:BanId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الحظر , الطرد , التقييد","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:set(TEAMLANA.."TEAMLANA:Status:Games"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:set(TEAMLANA.."TEAMLANA:Status:KickMe"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت اطردني ","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:BotFree",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت البوت الخدمي ","md",true)
end
...
Redis:set(TEAMLANA.."TEAMLANA:TwaslBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت التواصل داخل البوت ","md",true)
end

end

if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TEAMLANA.."TEAMLANA1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TEAMLANA.."TEAMLANA1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."TEAMLANA1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TEAMLANA..'TEAMLANA1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TEAMLANA..'TEAMLANA1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TEAMLANA..'TEAMLANA1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TEAMLANA.."TEAMLANA1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TEAMLANA.."TEAMLANA1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TEAMLANA.."TEAMLANA1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TEAMLANA.."TEAMLANA1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TEAMLANA.."TEAMLANA1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TEAMLANA.."TEAMLANA1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TEAMLANA.."TEAMLANA1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TEAMLANA.."TEAMLANA1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TEAMLANA.."TEAMLANA1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TEAMLANA.."TEAMLANA1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TEAMLANA.."ardode:List:Rd:Sudo", text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ',"md",true) 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TEAMLANA.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text1'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text2'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text3'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text4'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text5'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text6'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text7'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text8'..text)
Redis:del(TEAMLANA..'ardode:Add:Rd:Sudo:Text9'..text)
Redis:del(TEAMLANA.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TEAMLANA.."ardode:List:Rd:Sudo", text)
...
local list = Redis:smembers(TEAMLANA.."ardode:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text1"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text2"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text3"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text4"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text5"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text6"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text7"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text8"..v) 
Redis:del(TEAMLANA.."ardode:Add:Rd:Sudo:Text9"..v) 
Redis:del(TEAMLANA.."ardode:List:Rd:Sudo")
end
...
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TEAMLANA.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text2"..test, text)  
end
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd3" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd4')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text3"..test, text)  
end
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd4" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd5')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text4"..test, text)  
end
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd5" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd6')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text5"..test, text)  
end
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd6" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd7')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text6"..test, text)  
end
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd7" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd8')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text7"..test, text)  
end
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd8" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd9')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text8"..test, text)  
end
...
if text then  
local test = Redis:get(TEAMLANA.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd9" then
Redis:set(TEAMLANA.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd10')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TEAMLANA.."ardode:Add:Rd:Sudo:Text9"..test, text)  
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text2"..text)
local Text3 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text3"..text)
local Text4 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text4"..text)
local Text5 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text5"..text)
local Text6 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text6"..text)
local Text7 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text7"..text)
local Text8 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text8"..text)
local Text9 = Redis:get(TEAMLANA.."ardode:Add:Rd:Sudo:Text9"..text)   
...
Redis:sadd(TEAMLANA.."TEAMLANA:allM"..msg.chat_id, msg.id)
if Redis:get(TEAMLANA.."TEAMLANA:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TEAMLANA.."TEAMLANA:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TEAMLANA.."TEAMLANA:allM"..msg.chat_id)
...
Redis:del(TEAMLANA.."TEAMLANA:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TEAMLANA.."TEAMLANA:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TEAMLANA.."TEAMLANA:allM"..msg.chat_id)  
...
Redis:del(TEAMLANA.."TEAMLANA:Status:Del:Media"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,'⌯ تم عطلت المسح التلقائي للميديا')
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Status:Del:Media"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'⌯ تم فعلت المسح التلقائي للميديا')
return false
end 
...
{
{text = '⌯  𝙻𝙰𝙽𝙰 𝚂𝙾𝚄𝚁𝙲𝙴  .',url="t.me/B_5_J"}
},
}
...
Rink = 1
elseif Redis:sismember(TEAMLANA.."TEAMLANA:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TEAMLANA.."TEAMLANA:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'- تم عطلت @all من قبل المدراء',"md",true)  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚃𝙾𝙺𝚈𝙾',url="https://t.me/X_X_T"},{text = '  ',url="https://t.me/k"}},
...
Redis:del(TEAMLANA.."TEAMLANA:Status:joinet"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت التحقق ","md",true)
end
if text == 'تفعيل التحقق' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص : ( '..Controller_Num(7)..' ) ',"md",true)  
end
Redis:set(TEAMLANA.."TEAMLANA:Status:joinet"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم فعلت التحقق ","md",true)
end
...
if TextMsg == 'الرابط' then
Redis:del(TEAMLANA.."TEAMLANA:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TEAMLANA.."TEAMLANA:Status:Welcome"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الترحيب ","md",true)
end
if TextMsg == 'الايدي' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:Status:Id"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الايدي ","md",true)
end
if TextMsg == 'الايدي بالصوره' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:Status:IdPhoto"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الايدي بالصوره ","md",true)
end
if TextMsg == 'الردود' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:Status:Reply"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الردود ","md",true)
end
if TextMsg == 'الردود العامه' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:Status:ReplySudo"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الردود العامه ","md",true)
end
if TextMsg == 'الحظر' or TextMsg == 'الطرد' or TextMsg == 'التقييد' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:Status:BanId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الحظر , الطرد , التقييد","md",true)
end
if TextMsg == 'الرفع' then
if not msg.Originators then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(5)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(TEAMLANA.."TEAMLANA:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(TEAMLANA.."TEAMLANA:Status:KickMe"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت اطردني ","md",true)
end
if TextMsg == 'البوت الخدمي' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:BotFree") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت البوت الخدمي ","md",true)
end
if TextMsg == 'التواصل' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
...
Redis:del(TEAMLANA.."TEAMLANA:TwaslBot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت التواصل داخل البوت ","md",true)
end
...
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ عذراً مافيه حساب بهذا المعرف .","md",true)  
end
if UserId_Info.type.is_channel == true then
...
if Redis:sismember(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم الغاء كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:kkytmAll:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:kkytmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:kkytmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:kkytmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم الغاء كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:kkytmAll:Groups",UserId) 
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:kkytmAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ مافيه مكتومين عام حالياًً . ","md",true)  
end
ListMembers = '\n⌯ قائمة المكتومين عام : \n↫ ┄┄┄┄┄𝙻𝙰𝙽𝙰┄┄┄┄┄ ↬ \n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if Redis:sismember(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TEAMLANA.."TEAMLANA:Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ عذراً مافيه حساب بهاذا المعرف ","md",true)  
...
if Redis:sismember(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TEAMLANA.."TEAMLANA:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TEAMLANA.."TEAMLANA:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:BanAll:Groups",UserId) 
...
if Redis:sismember(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TEAMLANA.."TEAMLANA:Status:KickMe"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ امر اطردني تم عطلته من قبل المدراء ","md",true)  
end
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ عذراً البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له ","md",true)  
end
...
if KickMe == true then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ عذرا ما اقدر طرد ادمنيه ومنشئين المجموعه","md",true)    
end
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم قفلت القنوات").Lock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:text"..msg_chat_id,true) 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:tagservr"..msg_chat_id,true)  
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم عطلت المنشن").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فعلت المنشن").Lock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TEAMLANA..'TEAMLANA:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:AddMempar"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت اضافة الاعضاء").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت القنوات").unLock,"md",true)  
return false
end 
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:text"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الدردشه").unLock,"md",true)  
return false
end 
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Join"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت دخول الاعضاء").unLock,"md",true)  
return false
end 
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TEAMLANA.."TEAMLANA:lockpin"..msg_chat_id)  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:edit"..msg_chat_id) 
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TEAMLANA..'TEAMLANA:'..lock..msg_chat_id)    
end
...
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TEAMLANA.."TEAMLANA:Spam:Group:User"..msg_chat_id ,"Spam:User")  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت التكرار").unLock,"md",true)  
end
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Link"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الروابط").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:User:Name"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت المعرفات").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:hashtak"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت التاك").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Cmd"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الشارحه").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Photo"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الصور").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Video"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الفيديو").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Animation"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت المتحركه").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:geam"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الالعاب").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Audio"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الاغاني").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:vico"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الصوت").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Keyboard"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الكيبورد").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Sticker"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الملصقات").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:forward"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت التوجيه").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Document"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الملفات").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Unsupported"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت السيلفي").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Markdaun"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الماركداون").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Contact"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الجهات").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Spam"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الكلايش").unLock,"md",true)  
return false
end 
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TEAMLANA.."TEAMLANA:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TEAMLANA.."TEAMLANA:Lock:Inlen"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌯ تم فتحت الانلاين").unLock,"md",true)  
return false
end 
...
Redis:setex(TEAMLANA.."TEAMLANA:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TEAMLANA.."TEAMLANA:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TEAMLANA.."TEAMLANA:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TEAMLANA.."TEAMLANA:Group:Link"..msg_chat_id) 
if GetLink then
...
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ ما اقدر جلب الرابط بسبب ليس لدي صلاحيه دعوه مستخدمين من خلال الرابط ","md",false)
end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(TEAMLANA.."TEAMLANA:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TEAMLANA.."TEAMLANA:Status:Welcome"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم عطلت الترحيب من قبل الادمنيه","md",true)
end 
local Welcome = Redis:get(TEAMLANA.."TEAMLANA:Welcome:Group"..msg_chat_id)
if Welcome then 
...
Redis:del(TEAMLANA.."TEAMLANA:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TEAMLANA.."TEAMLANA:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TEAMLANA.."TEAMLANA:Group:Rules"..msg_chat_id) 
...
local Rules = Redis:get(TEAMLANA.."TEAMLANA:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TEAMLANA.."TEAMLANA:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TEAMLANA.."TEAMLANA:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TEAMLANA.."TEAMLANA:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TEAMLANA.."TEAMLANA:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TEAMLANA.."TEAMLANA:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TEAMLANA..'TEAMLANA:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌯ ارسل الان  ملصق ,متحركه ,صوره ,رساله  ',"md",true)  
end
...
Redis:set(TEAMLANA.."TEAMLANA:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TEAMLANA.."TEAMLANA:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TEAMLANA.."TEAMLANA:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TEAMLANA.."TEAMLANA:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TEAMLANA.."TEAMLANA:Status:Link"..msg.chat_id) then
Statuslink = '❬ √ ❭' else Statuslink = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ √ ❭' else StatusWelcome = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:Id"..msg.chat_id) then
StatusId = '❬ √ ❭' else StatusId = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ √ ❭' else StatusIdPhoto = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:Reply"..msg.chat_id) then
StatusReply = '❬ √ ❭' else StatusReply = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ √ ❭' else StatusReplySudo = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ √ ❭' else StatusBanId = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ √ ❭' else StatusSetId = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:Games"..msg.chat_id) then
StatusGames = '❬ √ ❭' else StatusGames = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ √ ❭' else Statuskickme = '❬ 𝚇 ❭'
end
if Redis:get(TEAMLANA.."TEAMLANA:Status:AddMe"..msg.chat_id) then
StatusAddme = '❬ √ ❭' else StatusAddme = '❬ 𝚇 ❭'
end
...
Rink = 1
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TEAMLANA..'TEAMLANA:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌯ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TEAMLANA..'TEAMLANA:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌯ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TEAMLANA..'TEAMLANA:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌯ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌯ عدد رسائلك هنا '..(Redis:get(TEAMLANA..'TEAMLANA:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌯ عدد التعديلات هنا ⌯'..(Redis:get(TEAMLANA..'TEAMLANA:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌯ عدد جهاتك المضافه هنا ⌯'..(Redis:get(TEAMLANA.."TEAMLANA:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'',"md",true)  
...
Redis:setex(TEAMLANA.."TEAMLANA:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(TEAMLANA.."TEAMLANA:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌯ اهلا عزيزي , يمكنك تعيين الايدي الان
⌯ يمكنك استخدام الدوال الاتية :
⌯ `#اليوزر` ↫ يوزر المستخدم
...
Redis:del(TEAMLANA.."TEAMLANA:Set:Id:all")
...
Redis:del(TEAMLANA.."TEAMLANA:Set:Id:Group"..msg.chat_id)
...
Redis:del(TEAMLANA.."TEAMLANA:DevelopersQ:Groups") 
...
Redis:del(TEAMLANA.."TEAMLANA:Developers:Groups") 
...
Redis:del(TEAMLANA.."TEAMLANA:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TEAMLANA.."TEAMLANA:Originators:Group"..msg_chat_id) 
...
Redis:del(TEAMLANA.."TEAMLANA:Managers:Group"..msg_chat_id) 
...
Redis:del(TEAMLANA.."TEAMLANA:Addictive:Group"..msg_chat_id) 
...
Redis:del(TEAMLANA.."TEAMLANA:Distinguished:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TEAMLANA.."TEAMLANA:kkytmAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ مافيه مكتومين عام","md",true)  
end
Redis:del(TEAMLANA.."TEAMLANA:kkytmAll:Groups") 
...
Redis:del(TEAMLANA.."TEAMLANA:BanAll:Groups") 
...
Redis:del(TEAMLANA.."TEAMLANA:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TEAMLANA.."TEAMLANA:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TEAMLANA.."TEAMLANA:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TEAMLANA.."TEAMLANA:List:Manager"..msg_chat_id)
end
...
text = "⌯ قائمه الردود \n↫ ┄┄┄┄┄𝙻𝙰𝙽𝙰┄┄┄┄┄ ↬ \n"
for k,v in pairs(list) do
if Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌯ "
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
if #list == 0 then
text = "⌯ عذرا مافيه ردود في المجموعه"
end
...
Redis:set(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TEAMLANA.."TEAMLANA:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TEAMLANA.."TEAMLANA:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Gif"..v)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:vico"..v)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:stekr"..v)     
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Text"..v)   
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Photo"..v)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Video"..v)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:File"..v)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Audio"..v)
Redis:del(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:video_note"..v)
Redis:del(TEAMLANA.."TEAMLANA:List:Rd:Sudo")
end
...
text = "\n⌯ قائمة الردود العامه \n↫ ┄┄┄┄┄𝙻𝙰𝙽𝙰┄┄┄┄┄ ↬ \n"
for k,v in pairs(list) do
if Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:File"..v) then
db = "ملف ⌯ "
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TEAMLANA.."TEAMLANA:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
...
Redis:set(TEAMLANA.."TEAMLANA:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ اهلا عزيزي , ارسل الان الرد لأضافته ","md",true)  
end
...
Redis:set(TEAMLANA.."TEAMLANA:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ اهلا عزيزي , ارسل الان الرد لحذفه ","md",true)  
end
...
Redis:setex(TEAMLANA.."TEAMLANA:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⌯ ارسل لي سواء كان 
...
Redis:setex(TEAMLANA.."TEAMLANA:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯|ارسل لي سواء كان 
❨ ملف ⌯ ملصق ⌯ متحركه ⌯ صوره
 ⌯ فيديو ⌯ بصمه الفيديو ⌯ بصمه ⌯ صوت ⌯ رساله ❩
...
Redis:setex(TEAMLANA.."TEAMLANA:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TEAMLANA.."TEAMLANA:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TEAMLANA..'TEAMLANA:GetTexting:DevTEAMLANA'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:setex(TEAMLANA.."TEAMLANA:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
x = x + 1
Redis:srem(TEAMLANA..'TEAMLANA:Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(TEAMLANA..'TEAMLANA:ChekBotAdd',Get_Chat.id)
...
Redis:set(TEAMLANA.."TEAMLANA:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TEAMLANA.."TEAMLANA:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TEAMLANA.."TEAMLANA:Game:Riddles"..msg.chat_id,name)
...
if text == "كلزق" or text == "كلتبن"  or text == "كلخرا" or text == "كليزق" then
local BotName = {
"قليل ادب",
"واحد وسخ ",
"وصخ",
...
Redis:set(TEAMLANA.."TEAMLANA:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(TEAMLANA.."TEAMLANA:Status:Games"..msg.chat_id) then
Redis:del(TEAMLANA.."TEAMLANA:Set:Aks"..msg.chat_id)
...
Redis:set(TEAMLANA.."TEAMLANA:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TEAMLANA.."TEAMLANA:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TEAMLANA.."TEAMLANA:Game:Difference"..msg.chat_id,name)
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ ما اقدر البيع اقل من 1 ","md",true)  
end
local NumberGame = Redis:get(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TEAMLANA.."TEAMLANA:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'C','رفع C')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TEAMLANA.."TEAMLANA:Get:Reides:Commands:Group"..msg_chat_id..":"..'CM','رفع CM')
...
{
{text = 'تحديثات لبوت', url = 't.me/B_5_J'}, 
},
}
}
...
Redis:setex(TEAMLANA.."TEAMLANA:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TEAMLANA.."TEAMLANA:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TEAMLANA.."TEAMLANA:TwaslBot") and not Redis:sismember(TEAMLANA.."TEAMLANA:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TEAMLANA.."TEAMLANA:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TEAMLANA.."TEAMLANA:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TEAMLANA..'TEAMLANA:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⌯ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TEAMLANA..'TEAMLANA:BaN:In:Tuasl',Info_User)  
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⌯ قام بحظر البوت ما اقدر ارسال رسالتك ').Reply,"md",true)  
end
if msg.content.video_note then
...
Redis:srem(TEAMLANA.."TEAMLANA:ChekBotAdd",'-100'..data.supergroup.id)
...
if Redis:get(TEAMLANA.."TEAMLANA:Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(TEAMLANA..'TEAMLANA:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return LuaTele.sendText(data.message.chat_id, data.message.id, '⌯ لازم تختار انا لست بوت لتخطي نضام التحقق', 'md',false, false, false, false, reply_markup)
end
...
Redis:incr(TEAMLANA..'TEAMLANA:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TEAMLANA.."TEAMLANA:Lock:edit"..data.chat_id) then
...
local inget = Redis:get(TEAMLANA..'bainbots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(TEAMLANA..'bainbots'..idnum..UserId_Info.id,username[1])
Redis:set(TEAMLANA..'bainbots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:srem(TEAMLANA.."TEAMLANA:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TEAMLANA.."TEAMLANA:BanGroup:Group"..ChatId,listYt[2]) 
...
Redis:del(TEAMLANA.."TEAMLANA:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TEAMLANA.."TEAMLANA1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TEAMLANA.."TEAMLANA:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TEAMLANA.."TEAMLANA:Redis:Id:all"..ChatId..""..IdUser) 
Redis:del(TEAMLANA.."TEAMLANA:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TEAMLANA.."TEAMLANA:Redis:Id:all"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TEAMLANA.."TEAMLANA:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TEAMLANA.."TEAMLANA1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TEAMLANA.."TEAMLANA:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"⌯ ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TEAMLANA.."TEAMLANA:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"⌯ ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TEAMLANA.."TEAMLANA:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:Link"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الرابط").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_welcome') then
local UserId = Text:match('(%d+)/unmute_welcome')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الترحيب").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_Id') then
local UserId = Text:match('(%d+)/unmute_Id')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الايدي").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_IdPhoto') then
local UserId = Text:match('(%d+)/unmute_IdPhoto')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الايدي بالصوره").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_ryple') then
local UserId = Text:match('(%d+)/unmute_ryple')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الردود").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_ryplesudo') then
local UserId = Text:match('(%d+)/unmute_ryplesudo')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_setadmib') then
local UserId = Text:match('(%d+)/unmute_setadmib')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الرفع").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_kickmembars') then
local UserId = Text:match('(%d+)/unmute_kickmembars')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الطرد ⌯ الحظر").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_games') then
local UserId = Text:match('(%d+)/unmute_games')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر الالعاب").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_kickme') then
local UserId = Text:match('(%d+)/unmute_kickme')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم عطلت امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
if Text and Text:match('(%d+)/mute_link') then
local UserId = Text:match('(%d+)/mute_link')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الرابط").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_welcome') then
local UserId = Text:match('(%d+)/mute_welcome')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الترحيب").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_Id') then
local UserId = Text:match('(%d+)/mute_Id')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الايدي").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_IdPhoto') then
local UserId = Text:match('(%d+)/mute_IdPhoto')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الايدي بالصوره").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_ryple') then
local UserId = Text:match('(%d+)/mute_ryple')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الردود").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_ryplesudo') then
local UserId = Text:match('(%d+)/mute_ryplesudo')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_setadmib') then
local UserId = Text:match('(%d+)/mute_setadmib')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الرفع").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_kickmembars') then
local UserId = Text:match('(%d+)/mute_kickmembars')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الطرد ⌯ الحظر").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_games') then
local UserId = Text:match('(%d+)/mute_games')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر الالعاب").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/mute_kickme') then
local UserId = Text:match('(%d+)/mute_kickme')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TEAMLANA.."TEAMLANA:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فعلت امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TEAMLANA.."TEAMLANA:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TEAMLANA.."TEAMLANA:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TEAMLANA.."TEAMLANA:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TEAMLANA..'TEAMLANA:'..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "⌯ تم قفلت جميع الاوامر بنجاح  ", true)
end
end
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم عطلت صلاحيه تغيير المعلومات", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,'❬ 𝚇 ❭',nil,nil,nil,nil,nil)
LuaTele.setChatMemberStatus(ChatId,UserId[2],'administrator',{0 ,0, 0, 0, 0,0,0,1,0})
else
LuaTele.answerCallbackQuery(data.id, "⌯ تم فعلت صلاحيه تغيير المعلومات", true)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم عطلت صلاحيه التثبيت", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,'❬ 𝚇 ❭',nil,nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم فعلت صلاحيه التثبيت", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,'❬ √ ❭',nil,nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم عطلت صلاحيه الحظر", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,'❬ 𝚇 ❭',nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم فعلت صلاحيه الحظر", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,'❬ √ ❭',nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم عطلت صلاحيه دعوه المستخدمين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,'❬ 𝚇 ❭',nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم فعلت صلاحيه دعوه المستخدمين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,'❬ √ ❭',nil,nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم عطلت صلاحيه مسح الرسائل", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,'❬ 𝚇 ❭',nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم فعلت صلاحيه مسح الرسائل", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,'❬ √ ❭',nil)
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم عطلت صلاحيه اضافه مشرفين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,nil,'❬ 𝚇 ❭')
...
LuaTele.answerCallbackQuery(data.id, "⌯ تم فعلت صلاحيه اضافه مشرفين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,nil,'❬ √ ❭')
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الروابط", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الكلايش", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الكيبورد", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الاغاني", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر المتحركات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الملفات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الدردشه", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الفيديو", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الصور", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر المعرفات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر التاك", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر البوتات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر التوجيه", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الصوت", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الملصقات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الجهات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الدخول", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الاضافه", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر بصمه الفيديو", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر التثبيت", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الاشعارات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الماركدون", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر التعديل", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر الالعاب", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"⌯ لازم تختار نوع القفل او الفتح على امر التكرار", 'md', true, false, reply_markup)
end

elseif Text and Text:match('(%d+)/unlock_link') then
local UserId = Text:match('(%d+)/unlock_link')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الروابط").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_spam') then
local UserId = Text:match('(%d+)/unlock_spam')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الكلايش").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_keypord') then
local UserId = Text:match('(%d+)/unlock_keypord')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الكيبورد").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_voice') then
local UserId = Text:match('(%d+)/unlock_voice')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الاغاني").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_gif') then
local UserId = Text:match('(%d+)/unlock_gif')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت المتحركات").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_files') then
local UserId = Text:match('(%d+)/unlock_files')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الملفات").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_text') then
local UserId = Text:match('(%d+)/unlock_text')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الدردشه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_video') then
local UserId = Text:match('(%d+)/unlock_video')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الفيديو").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_photo') then
local UserId = Text:match('(%d+)/unlock_photo')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الصور").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_username') then
local UserId = Text:match('(%d+)/unlock_username')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت المعرفات").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_tags') then
local UserId = Text:match('(%d+)/unlock_tags')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت التاك").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_bots') then
local UserId = Text:match('(%d+)/unlock_bots')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت البوتات").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_fwd') then
local UserId = Text:match('(%d+)/unlock_fwd')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت التوجيه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_audio') then
local UserId = Text:match('(%d+)/unlock_audio')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الصوت").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_stikear') then
local UserId = Text:match('(%d+)/unlock_stikear')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الملصقات").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_phone') then
local UserId = Text:match('(%d+)/unlock_phone')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الجهات").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_joine') then
local UserId = Text:match('(%d+)/unlock_joine')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الدخول").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_addmem') then
local UserId = Text:match('(%d+)/unlock_addmem')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الاضافه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_videonote') then
local UserId = Text:match('(%d+)/unlock_videonote')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت بصمه الفيديو").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_pin') then
local UserId = Text:match('(%d+)/unlock_pin')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت التثبيت").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_tgservir') then
local UserId = Text:match('(%d+)/unlock_tgservir')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الاشعارات").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_markdaun') then
local UserId = Text:match('(%d+)/unlock_markdaun')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الماركدون").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_edits') then
local UserId = Text:match('(%d+)/unlock_edits')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت التعديل").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_games') then
local UserId = Text:match('(%d+)/unlock_games')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت الالعاب").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_flood') then
local UserId = Text:match('(%d+)/unlock_flood')
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TEAMLANA.."TEAMLANA:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌯ تم فتحت التكرار").unLock, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⌯ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TEAMLANA.."TEAMLANA:SilentGroup:Group"..ChatId) 
